...
func _ready():
	...
	var door_up_Asset2 = $Doors/UpDoor2/LevelDoor4.sprite
	var door_down_Asset2 = $Doors/DownDoor2/LevelDoor.sprite
	...
	var door_up_collision2 = $Doors/UpDoor2/DoorCollision.collision
	...
	match entrance:
		"L top":
			...
			if "up" in global.matrix[global.current_point.x + 1][global.current_point.y + 1]["connections"]:
				door_up_Asset2.visible = true
				door_up_collision2.disabled = true
			else:
			...
			if "down" in global.matrix[global.current_point.x + 1][global.current_point.y + 1]["connections"]:
				door_down_Asset2.visible = true
				door_down_collision2.disabled = true
			else:
		...
		"L bottom right":
			...
			if "left" in global.matrix[global.current_point.x - 1][global.current_point.y - 1]["connections"]:
				door_left_Asset.visible = true
				door_left_collision.disabled = true
			else:
				door_left_Asset.visible = false
			...
			if "left" in global.matrix[global.current_point.x][global.current_point.y - 1]["connections"]:
				door_left_Asset2.visible = true
				door_left_collision2.disabled = true
			else:
				door_left_Asset2.visible = false
			...
			if "down" in global.matrix[global.current_point.x][global.current_point.y - 1]["connections"]:
				door_down_Asset.visible = true
				door_down_collision.disabled = true
			else:
				door_down_Asset.visible = false
		...
		"L bot":
			...
			if "up" in global.matrix[global.current_point.x][global.current_point.y + 1]["connections"]:
				door_up_Asset2.visible = true
				door_up_collision2.disabled = true
			else:
				door_up_Asset2.visible = false
...
func _on_level_door_4_body_entered_2(body):
	if body.has_method("player"):
		match entrance:
			"L top":
				if "up" in global.matrix[global.current_point.x + 1][global.current_point.y + 1]["connections"]:
...
func _on_level_door_body_entered_2(body):
	if body.has_method("player"):
		match entrance:
			"L top":
				if "down" in global.matrix[global.current_point.x + 1][global.current_point.y + 1]["connections"]:
